...
namespace Backend.FirebaseWebGL.Scripts.FirebaseBridge
{
    public static class FirebaseDatabase
    {
        ...
        [DllImport("__Internal")]
        public static extern void PostTokensReq(string path, int value6, string hash, string time, int timeStamp, string objectName, string callback,
            string fallback);
        ...
        [DllImport("__Internal")]
        public static extern void PostHistory(string path, string category, int year, int month, int day, string time, int value, string objectName, string callback,
            string fallback);
    }
}